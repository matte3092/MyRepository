...
/**
 * The Class ControllerInterceptorHandlerTrueTest.
 */
@WebAppConfiguration
@ContextConfiguration(classes = { WebConfig.class })
@SpringBootTest
public class ControllerInterceptorHandlerTrueTest {
	...
	@Spy
	@InjectMocks
	private ControllerInterceptorHandler handler = new ControllerInterceptorHandler(true);
